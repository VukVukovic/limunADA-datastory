...
$(document).ready(function() {
	...
	{"topic":"Foreign relations", "data_topics":["korea", "russia", "china"], "text" : "Here we see what were relationships with the following countries. Let us start with the US-Russian relationship. In 2016, US presidential election took place and there was an accusation that Russian officials helped Donald Trump. This was later investigated from 2017 to 2019 by special prosecutor Robert Mueller, who finally managed to prove this. This was also known as a Mueller investigation. As a result, we see a relatively high presence of Russia-related quotations in the media during 2017, 2018, and 2019.<br /> North Korea is another example of a country with complicated relations with the US. In 2017 President Donald Trump stated: \"There will be fire and fury if the isolated nation makes more threats against the United States\". Tensions between North Korea and the US are getting bigger and bigger. In 2018 Trump met with North Korean President Kim Jong-un for the first time. All these events made a huge impact when it comes to media. Tensions were reduced when a Peace treaty between North Korea and the US was signed. Media prefers to report about crisis rather than peace.<br />US-China relations were indeed complicated for the previous several years. Finally, the US relations with China were not very good either. In January 2018, US President Donald Trump began setting tariffs and other trade barriers on China, which explains the increase in interest in China. Moreover, this interest explodes in 2019 and 2020 when the COVID-19 breakout happened. "},
	{"topic":"Sexism", "data_topics":["sexism"], "text":"Different political parties addressed this issue almost in the same amounts during 2015 and 2016, but we see that afterward, democrats were in huge favor of this topic. What was so different between 2015 and 2016 in comparison to other years when it comes to sexism? We believe - elections. Remember that in the elections in 2016, Donald Trump and Hillary Clinton were running for president. It is logical to assume that republicans did not want Hillary to gain political points because she was a woman, so they had a strong campaign when it came to women's rights."},
	{"topic":"Terrorism", "data_topics":["terrorism"], "text": "ISIS was pretty active during 2015 and 2016 which is justified by the terrorist attacks which were performed all around the world. Fortunately, after the actions of the US military, they lost most of their territory by the end of 2017. Therefore, the frequency of quotations on the topic of terrorism has been decreasing."},
